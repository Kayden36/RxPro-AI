...
def run_gemini_inference(rx_text, instructions, api_key, image_file=None):
    ...
    """
    url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-pro:generateContent"  # Update with correct endpoint if needed
    headers = {
...
def customer_dashboard(username):
    ...
    with tab3:
        ...
        # API key placeholder (replace with your key)
        API_KEY = "AIzaSyBYKDVKNfL6lEtuu0E9nsH8sXt7tWVfQOg"
